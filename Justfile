...
dev-backend:
    ...
    export POLICIES_TABLE_NAME=the-run-policies
    export POLICY_REVISIONS_TABLE_NAME=the-run-policy-revisions
    export EMAIL_TEMPLATES_TABLE_NAME=the-run-email-templates
    export EMAIL_TEMPLATE_REVISIONS_TABLE_NAME=the-run-email-template-revisions
    export ADMIN_INVITATIONS_TABLE_NAME=the-run-admin-invitations
...
create-admin email='' password='' force='':
    ...
    : "${EMAIL_TEMPLATES_TABLE_NAME:=the-run-email-templates}"
    : "${EMAIL_TEMPLATE_REVISIONS_TABLE_NAME:=the-run-email-template-revisions}"
    : "${ADMIN_INVITATIONS_TABLE_NAME:=the-run-admin-invitations}"
    export RUNNERS_TABLE_NAME REGISTRATIONS_TABLE_NAME EVENTS_TABLE_NAME RACES_TABLE_NAME ACCOUNTS_TABLE_NAME AUTH_ATTEMPTS_TABLE_NAME MAGIC_TOKENS_TABLE_NAME AUDIT_TABLE_NAME RATE_LIMIT_TABLE_NAME POLICIES_TABLE_NAME POLICY_REVISIONS_TABLE_NAME EMAIL_TEMPLATES_TABLE_NAME EMAIL_TEMPLATE_REVISIONS_TABLE_NAME ADMIN_INVITATIONS_TABLE_NAME
    if [ -n "$FORCE" ]; then
